package me.rezscipts.rpg.horses;
...
import me.rezscipts.rpg.economy.ShardManager;
import me.rezscipts.rpg.npcs.NPCEntity;
import me.rezscipts.rpg.npcs.NPCType;
...
public class HorseVillager extends NPCEntity {
    ...
    public static String getAppearanceString(PlayerDataRPG pd) {
        ...
        switch (pd.horseVariant) {
            ...
            case UNDEAD_HORSE:
                ...
                return sb.toString();
            default:
                sb.append("Bugged Horse (report this to rezscipts pls)");
                return sb.toString();
        }
    ...
    public void interact(Player p, PlayerDataRPG pd) {
        ...
        if (pd.horseSpeed == 0 && pd.horseJump == 0) {
            ...
            Inventory i = MenuManager.createMenu(p, "The RPGExperience Stables", 6, new Object[][] {
                    { 0, 0, Material.BOOK, ChatColor.GREEN + "About Horses", new Object[] {
                            ChatColor.WHITE,
                            "Travel faster with a horse!",
                            null,
