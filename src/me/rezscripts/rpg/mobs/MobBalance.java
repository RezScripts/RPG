...
import me.rezscipts.rpg.items.StatsBalance;
...
public class MobBalance {
    ...
    public static long getMobHP(int level, double multiplier) {
        double base = StatsBalance.getDamageRangeCore(level) * 1.3;
    ...
    public static int[] getMobDamage(int level, double damageMultiplier, double rangeMultiplier) {
        long playerHP = StatsBalance.getHPCore(level) * 3 + level * 50 + StatsBalance.getDefenseCore(level) + 100;
