package me.rezscripts.rpg.classes;
...
public class ClassManager extends AbstractManagerRPG {
    ...
    public ClassManager(RPG plugin) {
        super(plugin);
    }
    ...
    public static void showAllClassMenu(final Player p, final PlayerDataRPG pd) {
        ...
        Inventory i = MenuManager.createMenu(p, "RPGExperience Classes", 1, new Object[][] {
                { 0, 0, Material.BOOK, ChatColor.GREEN + "About Classes", new Object[] {
                        ChatColor.WHITE,
                        "Everyone in RPGExperience can choose a class!",
                        ChatColor.WHITE,
                ...
                { 0, 2, Material.IRON_SWORD, ChatColor.AQUA + "Crusader", new Object[] {
                        ...
                        "",
                        ChatColor.AQUA,
                        "Crusaders are masters of the sword, and also the easiest class to play! Crusaders have a good variety of spells that allow them to alternate between a spell-spamming and left-clicking playstyle. If you want to be able to experience all RPGExperience has to offer but aren't great at combat, Crusader is a good class for you!",
                }, new Runnable() {
                    public void run() {
    ...
    private static void showSpellcastChoices(final Spellcast spellcast, final Player p, final PlayerDataRPG pd, final boolean villager) {
        ...
        for (Spell s : spells) {
            ...
            if (row >= 6) {
                p.sendMessage(ChatColor.RED + "Error code 102 - spell display. Please report this to rezscripts or Xerty!");
                break;
            }
        }
