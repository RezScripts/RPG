package me.rezscipts.rpg.utils;
...
public class RSerializer {
    ...
    public static Location deserializeLocation(String s) {
        ...
        try {
            ...
            World w = RPG.plugin.getServer().getWorld(data[5]);
            if (w == null) {
                w = RPG.plugin.getServer().getWorld(RPG.GAME_WORLD);
    ...
    public static String serializeItemStack(ItemStack itemStack) {
        ...
        if (str.contains("@")) {
            try {
                RMessages.announce("Error code 109: Item serialization @. Please report this to rezscipts or .");
