...
public class PartyCommand extends RPGAbstractCommand {
    ...
    public void executePlayer(final Player p, PlayerDataRPG pd, String[] args) {
        ...
        if (args.length == 0) {
            p.sendMessage("");
            p.sendMessage(ChatColor.YELLOW + " == " + ChatColor.GREEN + "RPGExperience Party System" + ChatColor.YELLOW + " == ");
            ...
            if (args[0].equalsIgnoreCase("help")) {
                p.sendMessage("");
                p.sendMessage(ChatColor.YELLOW + " == " + ChatColor.GREEN + "RPGExperience Party Commands" + ChatColor.YELLOW + " == ");
                p.sendMessage("");
                ...
                p.sendMessage("");
                p.sendMessage(ChatColor.YELLOW + " == " + ChatColor.GREEN + "RPGExperience Party EXP Bonuses" + ChatColor.YELLOW + " == ");
                p.sendMessage("");
