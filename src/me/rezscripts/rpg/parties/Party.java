package me.customscripts.rpg.parties;
...
import me.customscripts.rpg.PlayerDataRPG;
import me.customscripts.rpgexperience.chat.ChatFilter;
import me.customscripts.rpgexperience.chat.ChatManager;
import me.customscripts.rpgexperience.options.RPGOption;
import me.customscripts.rpgexperience.players.Rank;
import me.customscripts.rpgexperience.utils.RSound;
import me.customscripts.rpgexperience.utils.fanciful.FancyMessage;
    ...
    public void sendMessage(Player sender, String s) {
        ...
        for (Player p : getPlayers()) {
            if (p == null || !p.isOnline())
                continue;
            try {
                if (PartyManager.plugin.getPD(p) != null && PartyManager.plugin.getPD(p).getOption(RPGOption.CHAT_FILTER)) {
                    if (msgFiltered == null)
