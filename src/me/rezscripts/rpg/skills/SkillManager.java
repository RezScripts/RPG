package me.rezscipts.rpg.skills;
...
public class SkillManager extends AbstractManagerRPG {
...

    {
        ...
        TUTORIAL.text(">> Click here for a link to the skills tutorial!").color(ChatColor.YELLOW).link("http://rpgexperience.net/skills");
    }

    public SkillManager(RPG plugin) {
        super(plugin);
    }
