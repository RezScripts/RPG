package me.rezscipts.rpg.worldboss;
...
import me.rezscipts.rpg.warps.WarpManager;
import me.rezscipts.rpg.worldboss.bosses.BossGenerator;
import me.rezscipts.rpg.worldboss.bosses.DeathriderBossGenerator;
import me.rezscipts.rpg.worldboss.bosses.SentinelBossGenerator;
import me.rezscipts.rpg.worldboss.bosses.ZombieBossGenerator;
import me.rezscipts.rpgexperience.PlayerData;
...
public class WorldBossManager extends AbstractManagerRPG {
    ...
    public WorldBossManager(RPG plugin) {
        super(plugin);
    }

    @Override
    public void initialize() {
        world = plugin.getServer().createWorld(new WorldCreator(RPG.BOSS_WORLD));
        ...
        RScheduler.schedule(plugin, () -> {
            ...
            RScheduler.schedule(plugin, () -> {
                ...
                RScheduler.schedule(plugin, () -> {
                    ...
                    RMessages.announce(ChatColor.translateAlternateColorCodes('&', "&7>>> &eJoin the fight to protect RPGExperience!"));
                    for (Player p : plugin.getServer().getOnlinePlayers())
                        generator.playSound(p);
                }, RTicks.seconds(15));
            }, RTicks.minutes(2));
