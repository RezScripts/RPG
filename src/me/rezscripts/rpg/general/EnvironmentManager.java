...
import me.rezscipts.rpg.commands.builder.WorldEditCommand;
...
import me.rezscipts.rpgexperience.commands.mod.BackCommand;
import me.rezscipts.rpgexperience.players.Rank;
...
public class EnvironmentManager extends AbstractManagerRPG {
    ...
    public static final String[] BUILD_WORLD = { RPG.GAME_WORLD, RPG.LOBBY_WORLD, RPG.TUTORIAL_WORLD };

    public EnvironmentManager(RPG plugin) {
        super(plugin);
    }
    ...
    public void onBlockFlow(BlockFromToEvent event) {
        if (!event.getBlock().getWorld().getName().equals("flat") && !event.getBlock().getWorld().getName().contains("main") && !event.getBlock().getWorld().getName().equalsIgnoreCase(RPG.GAME_WORLD))
            event.setCancelled(true);
    }
    ...
    public void onChunkLoad(final ChunkLoadEvent event) {
        if (event.getWorld().getName().contains(RPG.GAME_WORLD) && event.isNewChunk()) {
